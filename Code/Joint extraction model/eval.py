...
class chunkEvaluator:
    ...
    def printInfo(self):
        ...
        if self.ner_chunk_eval== "boundaries_type":
            ...
            NER_socre_F1 = self.getF1(self.tpsNER, self.fpsNER, self.fnsNER)
        elif self.ner_chunk_eval== "boundaries":
        ...
        printer.print()
        REL_socre_F1 = self.getF1(self.tpsREL, self.fpsREL, self.fnsREL)
        return NER_socre_F1,REL_socre_F1
